...
param_interfaces__srv__SetNumberPizza_Request__are_equal(const param_interfaces__srv__SetNumberPizza_Request * lhs, const param_interfaces__srv__SetNumberPizza_Request * rhs)
{
  ...
  // num_usable_pizza
  if (lhs->num_usable_pizza != rhs->num_usable_pizza) {
    return false;
  }
  return true;
}
  ...
  param_interfaces__srv__SetNumberPizza_Request * output)
{
  ...
  // num_usable_pizza
  output->num_usable_pizza = input->num_usable_pizza;
  return true;
}
...
param_interfaces__srv__SetNumberPizza_Request__create()
{
  ...
  param_interfaces__srv__SetNumberPizza_Request * msg = (param_interfaces__srv__SetNumberPizza_Request *)allocator.allocate(sizeof(param_interfaces__srv__SetNumberPizza_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(param_interfaces__srv__SetNumberPizza_Request));
  bool success = param_interfaces__srv__SetNumberPizza_Request__init(msg);
  if (!success) {
...
param_interfaces__srv__SetNumberPizza_Request__destroy(param_interfaces__srv__SetNumberPizza_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    param_interfaces__srv__SetNumberPizza_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
param_interfaces__srv__SetNumberPizza_Request__Sequence__init(param_interfaces__srv__SetNumberPizza_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  param_interfaces__srv__SetNumberPizza_Request * data = NULL;

  if (size) {
    data = (param_interfaces__srv__SetNumberPizza_Request *)allocator.zero_allocate(size, sizeof(param_interfaces__srv__SetNumberPizza_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = param_interfaces__srv__SetNumberPizza_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        param_interfaces__srv__SetNumberPizza_Request__fini(&data[i - 1]);
      }
...
param_interfaces__srv__SetNumberPizza_Request__Sequence__fini(param_interfaces__srv__SetNumberPizza_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      param_interfaces__srv__SetNumberPizza_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  param_interfaces__srv__SetNumberPizza_Request__Sequence * array = (param_interfaces__srv__SetNumberPizza_Request__Sequence *)allocator.allocate(sizeof(param_interfaces__srv__SetNumberPizza_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = param_interfaces__srv__SetNumberPizza_Request__Sequence__init(array, size);
  if (!success) {
...
param_interfaces__srv__SetNumberPizza_Request__Sequence__destroy(param_interfaces__srv__SetNumberPizza_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    param_interfaces__srv__SetNumberPizza_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
param_interfaces__srv__SetNumberPizza_Request__Sequence__are_equal(const param_interfaces__srv__SetNumberPizza_Request__Sequence * lhs, const param_interfaces__srv__SetNumberPizza_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!param_interfaces__srv__SetNumberPizza_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  param_interfaces__srv__SetNumberPizza_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(param_interfaces__srv__SetNumberPizza_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    param_interfaces__srv__SetNumberPizza_Request * data =
      (param_interfaces__srv__SetNumberPizza_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!param_interfaces__srv__SetNumberPizza_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          param_interfaces__srv__SetNumberPizza_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!param_interfaces__srv__SetNumberPizza_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  param_interfaces__srv__SetNumberPizza_Response * msg = (param_interfaces__srv__SetNumberPizza_Response *)allocator.allocate(sizeof(param_interfaces__srv__SetNumberPizza_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(param_interfaces__srv__SetNumberPizza_Response));
  bool success = param_interfaces__srv__SetNumberPizza_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
param_interfaces__srv__SetNumberPizza_Response__destroy(param_interfaces__srv__SetNumberPizza_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    param_interfaces__srv__SetNumberPizza_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
param_interfaces__srv__SetNumberPizza_Response__Sequence__init(param_interfaces__srv__SetNumberPizza_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  param_interfaces__srv__SetNumberPizza_Response * data = NULL;

  if (size) {
    data = (param_interfaces__srv__SetNumberPizza_Response *)allocator.zero_allocate(size, sizeof(param_interfaces__srv__SetNumberPizza_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = param_interfaces__srv__SetNumberPizza_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        param_interfaces__srv__SetNumberPizza_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
param_interfaces__srv__SetNumberPizza_Response__Sequence__fini(param_interfaces__srv__SetNumberPizza_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      param_interfaces__srv__SetNumberPizza_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  param_interfaces__srv__SetNumberPizza_Response__Sequence * array = (param_interfaces__srv__SetNumberPizza_Response__Sequence *)allocator.allocate(sizeof(param_interfaces__srv__SetNumberPizza_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = param_interfaces__srv__SetNumberPizza_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
param_interfaces__srv__SetNumberPizza_Response__Sequence__destroy(param_interfaces__srv__SetNumberPizza_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    param_interfaces__srv__SetNumberPizza_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
param_interfaces__srv__SetNumberPizza_Response__Sequence__are_equal(const param_interfaces__srv__SetNumberPizza_Response__Sequence * lhs, const param_interfaces__srv__SetNumberPizza_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!param_interfaces__srv__SetNumberPizza_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  param_interfaces__srv__SetNumberPizza_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(param_interfaces__srv__SetNumberPizza_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    param_interfaces__srv__SetNumberPizza_Response * data =
      (param_interfaces__srv__SetNumberPizza_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!param_interfaces__srv__SetNumberPizza_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          param_interfaces__srv__SetNumberPizza_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!param_interfaces__srv__SetNumberPizza_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
